...
import com.zeda.Entity.Bean_model;
import com.zeda.Entity.Bean_version;
import com.zeda.Until.HttpUntil;
import com.zeda.Until.MD5Until;
import com.zeda.Until.ReadUntil;
import com.zeda.Until.SaveUntil;
...
//https://mapi.yiche.com/web_api/car_model_api/api/v1/master/get_master_list?cid=508&param=%7B%7D
    public void Method_1_RequestYiche_Brand(String savePath, String main_url, String fileName) {
        try {
            String content = httpUntil.Method_RequestAPI(main_url,"{}");
    ...
    public void Method_3_Down_FactoryANDModel(String savePath, String main_url, String fileName) {
        ...
        for (Object bean : BeanList) {
            ...
            if (DownState.equals("否")) {
                ...
                String connect = httpUntil.Method_RequestAPI(main_url, param);
        ...
        for (Object bean : BeanList) {
            ...
            if (brandid.equals("9")||brandid.equals("2")||brandid.equals("3")){
                ...
                if (DownState.equals("否")) {
                    ...
                    String content = httpUntil.Method_RequestAPI(main_url, param);
                    if (!content.equals("Error")) {
                        System.out.println(C_ID);
//                    System.out.println(content);
